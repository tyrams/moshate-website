      ...
      {isPopular && (
        <div
          className={cn(
            ...
            // Overlay
            '[background:linear-gradient(0.04deg,#334195_16.34%,#0E0E0E_127.37%)] dark:[background:linear-gradient(90deg,rgba(51,65,149,1)_0%,rgba(51,65,149,0.5634628851540616)_43%,rgba(51,65,149,0.10968137254901966)_99%)]',
            // arrow shape
