            ...
            <>
              ...
              >
                <AccordionTrigger
                  className={cn(
                    menuItemClasses,
                    "[&[data-state='open']&_.accordion-icon]:-rotate-180 [&[data-state='open']]:bg-accent-100 [&[data-state='open']]:text-primary dark:[&[data-state='open']]:bg-primary dark:[&[data-state='open']]:text-white"
                  )}
                >
                  {menuItem.title}
